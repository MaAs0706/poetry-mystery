...
export default function App() {
  ...
  const [spreadStart, setSpreadStart] = useState(0); const [turning, setTurning] = useState(false); const [turnDirection, setTurnDirection] = useState('forward'); const [typed, setTyped] = useState(['', '', '']);
